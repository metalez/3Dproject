#ifndef LIMITEDPLANE_HPP
#define LIMITEDPLANE_HPP
...
public:
     ...
     */
    LimitedPlane(const glm::vec3& normal, const glm::vec3& point, const glm::vec3 tr, const glm::vec3 bl);



    virtual ~LimitedPlane();
...
typedef std::shared_ptr<LimitedPlane> LimitedPlanePtr;

#endif //LIMITEDPLANE_HPP